...
6. The online **script generator** has self-contained explanation. You can follow through what it asks you to fill. You can pick gain and passband calibrators using the online [SMA Calibrator List](http://sma1.sma.hawaii.edu/callist/callist.html). You can pick absolute flux calibrators using the online [Planetary Visibility Funciton Calculator](http://sma1.sma.hawaii.edu/callist/callist.html). You may use MWC349A for absolute flux calibration in case no planet or planet moon are available (e.g., above the horizon and is not resolved out) during the semester of your SMA observations.
